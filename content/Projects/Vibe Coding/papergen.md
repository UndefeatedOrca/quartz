...
More than just generic templates: this fills in the class info using a single click, saving untold seconds (which turn into minutes eventually). I have not saved time in my life by creating this, but it should save you time in your life to use it :)
