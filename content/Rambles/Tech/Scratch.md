...
modified:
---
Scratch. Yes, the block-based programming website. The website that introduced me to the concept of forums, online multiplayer games, and digital friends. I was in fifth grade when we started doing Scratch in AAP (the gifted program where I once made an aluminum foil boat that fit so many pennies we ran out and needed to get some from a kindergarten classroom[^1]). While most of my other classmates had limited interest, a whole new world opened up to me as I developed, tested, and illustrated projects of very limited use outside of the fifth grade. While my class stopped posting after the unit was over, I continued, developing calculators, clocks, games, and more, again, all of dubious quality.[^2]
...
In other words, the first time I used [ASCII Art](randomascii.md) was in my Scratch signature. Wow!
...
[^2]: The most beloved of all seems to be Candy Clicker which has been incessantly remixed. Some make literally no changes(?), others change the candy to something totally random, yet more inexplicably automate the game for reasons that I cannot comprehend.
	...
	![](https://substackcdn.com/image/fetch/$s_!ezX_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff5ec2b19-7762-469a-b8e8-7dee68a14f11_273x257.png)
	...
	Case in point:
	![](https://substackcdn.com/image/fetch/$s_!udJ_!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe4034297-dfa7-44d7-a855-eaa75a599d3e_902x357.png)
	
	Bonus screenshot because the comments section on this particular project is nuts:
	![](https://substackcdn.com/image/fetch/$s_!P-z2!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2b65441d-e218-4547-8681-13c0f247acae_701x826.png)
...
[^6]: The vast majority of these collaborations were doomed from the start and far too broad reaching. Even so, a few genuinely impressive projects have managed to emerge from that graveyard of fallen dreams that is the “Collaborations” section.
	...
	Well, that and this:
	![](https://substackcdn.com/image/fetch/$s_!PDz4!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3c5dfda6-8a2c-48ce-b90c-6589cfbe8d31_1187x322.png)
